...
var json_utility_1 = require("./json-utility");
var CardRepository = /** @class */ (function () {
    function CardRepository(filePath) {
        this.cardsFilePath = filePath;
    }
    CardRepository.prototype.getCards = function () {
        return __awaiter(this, void 0, void 0, function () {
            var jsonData, cards, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, json_utility_1.JsonUtilityClass.readJsonFromFile(this.cardsFilePath)];
                    case 1:
                        jsonData = _a.sent();
